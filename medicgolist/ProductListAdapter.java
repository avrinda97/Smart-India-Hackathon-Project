...
/**
 * Created by shubhanshu on 30/3/18.
 */
...
public class ProductListAdapter extends ArrayAdapter<Product> {
    ...
    SharedPreference sharedPreference1;
    ...
    public ProductListAdapter(Context context, List<Product> products) {
        ...
        sharedPreference1=new SharedPreference();
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (checkFavoriteItem(product)) {
            holder.favoriteImg.setImageResource(R.drawable.heart);
            holder.favoriteImg.setTag("red");
        } else {
            holder.favoriteImg.setImageResource(R.drawable.heart_gray);
